...
int BxAniGaussFilterFloat2D(float * in, float* out, float sigmax, float sigmay, int dimx, int dimy)
{
    ...
    if (v0==NULL || v1==NULL||v2==NULL||v3==NULL||vbound==NULL){
        ...
        printf("BxAniGaussFilterFloat2D: allocation failure\n");
        return -1;
    }
...
int BxAniGaussFilterShort2D(short * in, short* out, float sigmax, float sigmay, int dimx, int dimy)
{
    ...
    if (v0==NULL||v1==NULL||v2==NULL||v3==NULL||vbound==NULL){
        ...
        if (v3!=NULL){free(v3);}
        if (vbound!=NULL){free(vbound);}
        printf("BxAniGaussFilterShort2D: allocation failure\n");
        return -1;
    }
...
int BxAniGaussFilterShort2DROI(short * in, short* out, float sigmax, float sigmay, int dimx, int dimy
                               , int xMin, int xMax, int yMin, int yMax)
{
    ...
    if (v0==NULL||v1==NULL||v2==NULL||v3==NULL||vbound==NULL){
        ...
        if (v3!=NULL){free(v3);}
        if (vbound!=NULL){free(vbound);}
        printf("BxAniGaussFilterShort2DROI: allocation failure\n");
        return -1;
    }
...
{
	return BxAniGaussFilterShort2DROI(in,out,sigma,sigma,dimx,dimy, xMin, xMax, yMin, yMax); 
}
...
int BxAniGaussFilterFloat2D_SSE(float * in, float* out, float sigmax, float sigmay, int dimx, int dimy)
{
    ...
    if (v0==NULL||v1==NULL||v2==NULL||v3==NULL||vbound==NULL){
        ...
        if (v3!=NULL){free(v3);}
        if (vbound!=NULL){free(vbound);}
        printf("BxAniGaussFilterFloat2D_SSE: allocation failure\n");
        return -1;
    }
