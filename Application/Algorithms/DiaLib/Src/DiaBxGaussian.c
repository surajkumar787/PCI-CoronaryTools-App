...
int DiaBxGaussInitOrder3(float sigma, double * pB, double * pb1, double * pb2, double * pb3, double * M)
{
...
int DiaBxAniGaussFilterFloat2D(float * in, float* out, float sigmax, float sigmay, int dimx, int dimy)
{
    ...
    if (v0 == NULL || v1 == NULL || v2 == NULL || v3 == NULL || vbound == NULL){
        ...
        printf("DiaBxAniGaussFilterFloat2D: allocation error\n");
        return -1;
    }

	DiaBxGaussInitOrder3(sigmax, &B, &b1, &b2, &b3, M) ; 
	...
	DiaBxGaussInitOrder3(sigmay, &B, &b1, &b2, &b3, M) ; 
...
{
	return DiaBxAniGaussFilterFloat2D(in,out,sigma,sigma,dimx,dimy) ; 
}
...
int DiaBxAniGaussFilterShort2D(short * in, short* out, float sigmax, float sigmay, int dimx, int dimy)
{
    ...
    if (v0 == NULL || v1 == NULL || v2 == NULL || v3 == NULL || vbound == NULL){
        ...
        if (v3 != NULL){ free(v3);}
        if (vbound != NULL){ free(vbound);}
        printf("DiaBxAniGaussFilterShort2D: allocation error\n");
        return -1;
    }
	...
	for (y=0; y<dimy; y++)
	{
		for (x=0; x<dimx; x++)
		{
			...
			out[x] = DiaBxFastRoundShort(v0[x]) ;
		}
	...
	for (x=0; x<dimx; x++)
	{
		...
		out[x] = DiaBxFastRoundShort(v1[x]) ; 
	}
...
{
	return DiaBxAniGaussFilterShort2D(in,out,sigma,sigma,dimx,dimy) ; 
}
...
{
	return DiaBxAniGaussFilterFastShort2D(in,out,sigma,sigma,dimx,dimy) ; 
}
...
int DiaBxAniGaussFilterFloat2D_SSE(float * in, float* out, float sigmax, float sigmay, int dimx, int dimy)
{
    ...
    if (v0 == NULL || v1 == NULL || v2 == NULL ||v3 == NULL || vbound == NULL){
        ...
        if (v3 != NULL){ free(v3);}
        if (vbound != NULL){ free(vbound);}
        printf("DiaBxAniGaussFilterFloat2D_SSE: allocation error\n");
        return -1;
    }
...
{
    assert(((int) in)%16==0 && "in pointer should be aligned on 16 bytes");
    assert(((int) out)%16==0 && "out pointer should be aligned on 16 bytes");
    assert(dimx%4==0 && "dimx should be a multiple of 4");

	return DiaBxAniGaussFilterFloat2D_SSE(in, out, sigma, sigma, dimx, dimy) ;
}
...
int DiaBxAniGaussFilterFloat3D(float * in, float* out, float sigmax, float sigmay, float sigmaz, int dimx, int dimy, int dimz)
{
	...
	DiaBxGaussInitOrder3(sigmaz, &B, &b1, &b2, &b3, M) ; 
...
{
	return DiaBxAniGaussFilterFloat3D(in,out,sigma,sigma,sigma,dimx,dimy,dimz) ; 
}
...
int DiaBxAniGaussFilterShort3D_(short * in, short* out, float sigmax, float sigmay, float sigmaz, int dimx, int dimy, int dimz)
{
	int x, y, z ; 
	double M[9] ;
	double bound ; 
...
{
	return DiaBxAniGaussFilterShort3D(in,out,sigma,sigma,sigma,dimx,dimy,dimz) ; 
}
...
int DiaBxIsoGaussFilterFloat3D_SSE(float * in, float* out, float sigma, int dimx, int dimy, int dimz)
{
	...
	return DiaBxAniGaussFilterFloat3D_SSE(in, out, sigma, sigma, sigma, dimx, dimy, dimz) ;
}




/*int DiaBxAniGaussFilterShort2D_SSE(short * in, short* out, float sigmax, float sigmay, int dimx, int dimy)
{
	int x, y ; 
	double M[9] ;
	double bound ; 
...
int DiaBxIsoGaussFilterShort2D_SSE(short * in, short* out, float sigma, int dimx, int dimy)
{
	return DiaBxAniGaussFilterShort2D_SSE(in, out, sigma, sigma, dimx, dimy) ;
}*/