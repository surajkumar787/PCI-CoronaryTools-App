...
short SWBxFastRoundShort(double val)
{
...
int SWBxGaussInitOrder3(float sigma, double * pB, double * pb1, double * pb2, double * pb3, double * M)
{
...
int SWBxAniGaussFilterFloat2D(float * in, float* out, float sigmax, float sigmay, int dimx, int dimy)
{
	...
	SWBxGaussInitOrder3(sigmax, &B, &b1, &b2, &b3, M) ; 
	...
	SWBxGaussInitOrder3(sigmay, &B, &b1, &b2, &b3, M) ; 
...
int SWBxAniGaussFilterFloat2DROI(float * in, float* out, float sigmax, float sigmay, int dimx, int dimy
                               , int xMin, int xMax, int yMin, int yMax)
{
    ...
    memcpy(out, in,dimx*dimy*sizeof(float));
    //memset(out,0,dimx*dimy);
...
{
	return SWBxAniGaussFilterFloat2D(in,out,sigma,sigma,dimx,dimy) ; 
}

int SWBxIsoGaussFilterFloat2DROI(float * in, float* out, float sigma, int dimx, int dimy
                               , int xMin, int xMax, int yMin, int yMax){
    return SWBxAniGaussFilterFloat2DROI(in, out, sigma, sigma, dimx, dimy, xMin, xMax, yMin, yMax);
}
...
int SWBxAniGaussFilterShort2DROI(short * in, short* out, float sigmax, float sigmay, int dimx, int dimy
                               , int xMin, int xMax, int yMin, int yMax)
{
	int x, y ; 
	double M[9] ;
    ...
    memcpy(out, in,dimx*dimy*sizeof(short));
    //memset(out,0,dimx*dimy);
...
{
	return SWBxAniGaussFilterShort2D(in,out,sigma,sigma,dimx,dimy) ; 
}

int SWBxIsoGaussFilterShort2DROI(short * in, short* out, float sigma, int dimx, int dimy, int xMin, int xMax, int yMin, int yMax)
{
	return SWBxAniGaussFilterShort2DROI(in,out,sigma,sigma,dimx,dimy, xMin, xMax, yMin, yMax); 
}
...
{
	return SWBxAniGaussFilterFastShort2D(in,out,sigma,sigma,dimx,dimy) ; 
}
...
{
	return SWBxAniGaussFilterFloat2D_SSE(in, out, sigma, sigma, dimx, dimy) ;
}
...
int SWBxAniGaussFilterFloat3D(float * in, float* out, float sigmax, float sigmay, float sigmaz, int dimx, int dimy, int dimz)
{
	...
	SWBxGaussInitOrder3(sigmaz, &B, &b1, &b2, &b3, M) ; 
...
{
	return SWBxAniGaussFilterFloat3D(in,out,sigma,sigma,sigma,dimx,dimy,dimz) ; 
}
...
{
	return SWBxAniGaussFilterShort3D(in,out,sigma,sigma,sigma,dimx,dimy,dimz) ; 
}
...
{
	return SWBxAniGaussFilterFloat3D_SSE(in, out, sigma, sigma, sigma, dimx, dimy, dimz) ;
}

/*int SWBxAniGaussFilterShort2D_SSE(short * in, short* out, float sigmax, float sigmay, int dimx, int dimy)
{
	int x, y ; 
	double M[9] ;
	double bound ; 
...
int SWBxIsoGaussFilterShort2D_SSE(short * in, short* out, float sigma, int dimx, int dimy)
{
	return SWBxAniGaussFilterShort2D_SSE(in, out, sigma, sigma, dimx, dimy) ;
}*/