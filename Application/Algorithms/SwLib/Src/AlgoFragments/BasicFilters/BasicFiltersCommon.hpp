...
static inline Region2D Region2D_Make(int left, int top, int right, int bottom)
{
    return Region2D_Make<Region2D>(left, top, right, bottom);
}
...
template <typename TYPE>
static inline Image2D<TYPE> Image2D_Make(TYPE const * buffer0, int stride)
{
    Image2D<TYPE> img;
    img.BufferAtOrigin = (TYPE *)buffer0;
...
namespace Philips
{
    namespace Medisys
    {
        namespace AlgoFragments
        {
            ...
            using ::AlgoFragmentsImpl::Image2D_Make;
