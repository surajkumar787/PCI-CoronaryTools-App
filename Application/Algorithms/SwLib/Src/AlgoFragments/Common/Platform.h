...
#pragma message("Warning: Downgrading AVX/SSE. Maybe a compiler flag is missing for AVX ?")
#undef  PLATFORM_INTEL_SSE
#define PLATFORM_INTEL_SSE PLATFORM_INTEL_SSE_COMPILABLE
...
#define PLATFORM_ALIGNED_DEF PLATFORM_ALIGNED(PLATFORM_DEFAULT_ALIGN)
