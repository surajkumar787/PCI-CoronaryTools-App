...
LICENSE                              = 3018-0520-760B
IMPLEMENTATION_CLASS_UID             = 2.16.840.1
IMPLEMENTATION_VERSION               = MergeCOM3_5_8_0
...
DICTIONARY_FILE                         = %MC3INIDIR%mrgcom3.dct
MSG_INFO_FILE                           = %MC3INIDIR%mrgcom3.msg
TEMP_FILE_DIRECTORY                     = .
PEGASUS_OPCODE_PATH                     = .
...
#PEGASUS_OP_LIP3PLUS_NAME                = Philips Medical Systems Nederland B.V.
#PEGASUS_OP_LIP3PLUS_REGISTRATION        = 0x46A73A76
#PEGASUS_OP_LIE3PLUS_NAME                = Philips Medical Systems Nederland B.V.
#PEGASUS_OP_LIE3PLUS_REGISTRATION        = 0x46A73A76
#PEGASUS_OP_D2SEPLUS_NAME                = Philips Medical Systems Nederland B.V.
#PEGASUS_OP_D2SEPLUS_REGISTRATION        = 0x700B8C61
#PEGASUS_OP_SE2DPLUS_NAME                = Philips Medical Systems Nederland B.V.
#PEGASUS_OP_SE2DPLUS_REGISTRATION        = 0x389B200E
#PEGASUS_OP_J2KP_NAME                    = Philips Medical Systems Nederland B.V.
#PEGASUS_OP_J2KP_REGISTRATION            = 0x00000000
#PEGASUS_OP_J2KE_NAME                    = Philips Medical Systems Nederland B.V.
